    ...
    <div>
      ...
      <div
        className={clsx(
          ...
          "fixed left-0 z-2 max-h-[90vh] w-[100%] overflow-y-auto rounded-t-[.5rem] bg-white p-6 transition-[bottom] duration-400 ease-in-out",
      ...
      >
        ...
        <ul className="my-8">
          ...
          <ItemConfirm totalPrice={totalPrice} />
        </ul>
        <button
          onClick={reStart}
